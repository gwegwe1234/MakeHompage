		...
		<c:otherwise>
			<c:choose>
				...
				<c:otherwise>
					...
					<section>
						<div class="container">
							<form action="/MakeHompage/writeFreeboard" method="post">
								<div class="row">
									<hr class="star-primary">
									<h2>내용을 입력하세요</h2>
									<br /> <br />
									<table class="table">
										<tr>
											<td>제목</td>
											<td><input type="text" name="freeboardSubject"
												id="freeboardSubject" size="80" /></td>
										</tr>
										<tr>
											<td>내용</td>
											<td><textarea row="15" cols="100"
													name="freeboardContext" id="freeboardContext"></textarea></td>
										</tr>
									</table>
