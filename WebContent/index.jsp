...
<body id="page-top" class="index">
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="page-scroll"><a href="#login" class="portfolio-link"
		...
		<p style="color:white">${loginName }님이 접속중입니다.</p>
		</c:if>
		<!-- /.navbar-collapse -->
	</div>
	<!-- /.container-fluid --> </nav>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="intro-text">
					<span class="name">Show our Travel</span>
					<hr class="star-light">
					<span class="skills">Travel Story</span>
				</div>
			</div>
		</div>
	</div>
	...
	<form action="/MakeHompage/freeboard" method="post">
	<center>
		<input type="hidden" name="memberNo" id="memberNo" value="${memberNo }"/>
		<input type="submit" value="여행사진보러가기" class="btn btn-default"/>
	</center>
	</form>
	</section>
					...
					<div class="col-lg-8 col-lg-offset-2">
						<div class="modal-body">
							...
							<hr class="star-primary">
								...
								<div class="loginForm">
									<form method="post" name="" action="/MakeHompage/login">
										<div class="box">
											<input type="text" class="iText" name="memberId" id="memberId">
											<br> <input type="password" name="memberPw" id="memberPw" class="iText">
											<br>
											<!-- <p>
												<span class="fleft"><input type="checkbox" id=""><label
													for=""> 아이디 저장</label></span> <span class="fright"><a
													href="">아이디 찾기</a>&nbsp;|&nbsp;<a href="">비밀번호 찾기</a></span>
											</p> -->
										</div>
