...
<body id="page-top" class="index">
	...
	<c:choose>
		...
		<c:otherwise>
			...
			<br />
			<center>
				<h2>"${freeboardContext }"</h2>
				<br />
				<form action="/MakeHompage/writeReply" method="post">
					<input type="hidden" name="boardReRef" id="boardReRef"
						value="${boardReRef }" /> <input type="submit" value="답글 등록하기" />
				</form>
				<form action="/MakeHompage/deleteContext" method="post">
					<input type="hidden" name="boardId" id="boardId"
						value="${boardId }" /> <input type="hidden" name="boardNo"
						id="boardNo" value="${boardNo }" /><input type="submit"
						value="게시글 삭제" />
				</form>
